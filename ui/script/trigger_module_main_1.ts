module p_8e93 {
	export let 当前选中的防御塔id: number = 0;
	export let 游戏是否开始: boolean = false;
	...
	export class 点击防御塔升级按钮 extends TriggerEvent{
		...
		readonly event_name: string = "点击防御塔升级按钮"
	...
	export class 点击防御塔拆除按钮 extends TriggerEvent{
		...
		readonly event_name: string = "点击防御塔拆除按钮"
		readonly autoForward: boolean = false
	}
	export class 请求防御塔升级 extends TriggerEvent{
		constructor(public obj:unknown, public 防御塔id:number) {
			super()
		}
	...
	export let 游戏结束 = base.trigger_new(_TRIG_游戏结束_FUNC, [], false, undefined, true)
	...
	export let 更新血量 = base.trigger_new(_TRIG_更新血量_FUNC, [], false, undefined, true)
	...
	export let 更新金钱 = base.trigger_new(_TRIG_更新金钱_FUNC, [], false, undefined, true)
	...
	export let 取消选中防御塔 = base.trigger_new(_TRIG_取消选中防御塔_FUNC, [], false, undefined, true)
	...
	export let 点击升级防御塔 = base.trigger_new(_TRIG_点击升级防御塔_FUNC, [], false, undefined, true)
	...
	export let 点击拆除防御塔 = base.trigger_new(_TRIG_点击拆除防御塔_FUNC, [], false, undefined, true)
	//以下为转发事件
	export class 游戏结束 extends TriggerEvent{
		constructor(public obj:unknown, public 是否胜利:boolean) {
			super()
		}
	...
	export class 血量变化 extends TriggerEvent{
		constructor(public obj:unknown, public 血量:number) {
			super()
		}
	...
	export class 防御塔获得装备 extends TriggerEvent{
		constructor(public obj:unknown, public 防御塔id:number, public 装备图标资源路径:string) {
			super()
		}
	...
	export class 防御塔选中 extends TriggerEvent{
		constructor(public obj:unknown, public 防御塔id:number, public 玩家id:number, public 升级消耗:number, public 拆除返还:number, public 装备图标资源路径:string) {
			super()
		}
	...
	游戏结束.add_event_common({ obj: ((base.game) as unknown as base.Game), event_name: "游戏结束" })
	更新血量.add_event_common({ obj: ((base.game) as unknown as base.Game), event_name: "血量变化" })
	更新金钱.add_event_common({ obj: ((base.any_player) as unknown as base.PPlayerAny), event_name: "玩家-属性变化" })
	选中防御塔.add_event_common({ obj: ((base.game) as unknown as base.Game), event_name: "防御塔选中" })
	取消选中防御塔.add_event_common({ obj: ((base.any_unit) as unknown as base.PUnitAny), event_name: "单位-取消选中" })
	点击升级防御塔.add_event_common({ obj: ((base.game) as unknown as base.Game), event_name: "点击防御塔升级按钮" })
	点击拆除防御塔.add_event_common({ obj: ((base.game) as unknown as base.Game), event_name: "点击防御塔拆除按钮" })
}
